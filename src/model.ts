...
const crearColeccionaDeCartasInicial = (infoCartas: InfoCarta[]): Carta[] => {
  const cartasDuplicadas: Carta[] = infoCartas.flatMap((infoCarta) => [
...
export let cartas: Carta[] = crearColeccionaDeCartasInicial(infoCartas);
